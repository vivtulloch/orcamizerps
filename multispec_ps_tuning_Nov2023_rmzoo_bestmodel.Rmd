...
```{r}
plotGrowthCurves(cel_model, species_panel = TRUE)
plotFeedingLevel(cel_model)
plotResourcePred(cel_model, proportion = T)
...
# run without fishing
sim <- project(cel_model, t_max = 100, effort =0, t_save=3)
...
```{r}
saveParams(cel_model, "bestmodel_231127_nofishing_tuneparams.rds")
